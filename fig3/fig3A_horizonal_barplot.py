...
input_dir = ['metaz_plot','metaz_plot_OR']
output_dir = [' 84cancer',' OR']
...
for i,o in zip(input_dir,output_dir):
    op_dir = 'Enriched pan-cancer-related pathways'+o+'_flat.png'
    
    data_df = pd.read_csv(i+'.txt', delimiter = "\t",index_col=0)
    ...
    result_df = result_df[result_df.methods!="Gscore_v1"]
    ...
    plt.savefig('4A/'+op_dir,bbox_inches='tight')
    plt.show()