...
for k in plot_d:
  with open ('D:\\Job\\handover\\Fig2\\data_for_fig\\percentage_all_methods\\association_per_1.txt') as f:
    lines =f.readlines()
    for line in lines[1:]:
  ...
  plt.title(k+'_347_percentage')
  plt.xlabel('Methods',fontsize=15)
  plt.ylabel('Percentage (%)',fontsize=15)
  ax.legend(bbox_to_anchor=(1.35,0.6),fontsize=10)
  plt.savefig('D:\\Job\\handover\\Fig2\\Figs\\0.5\\Fig2A\\'+k+'_347_enriched_vs_non-enriched_bg.png',bbox_inches='tight',dpi=300)
  plt.show()
